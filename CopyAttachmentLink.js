...
(function () {
  ...
  function addContextMenuButtons(replybutton,svg){
    ...
    const copytextbutton = document.querySelector(`a:has(svg>path[d='M360-240q-33 0-56.5-23.5T280-320v-480q0-33 23.5-56.5T360-880h360q33 0 56.5 23.5T800-800v480q0 33-23.5 56.5T720-240H360Zm0-80h360v-480H360v480ZM200-80q-33 0-56.5-23.5T120-160v-560h80v560h440v80H200Zm160-240v-480 480Z'])`)
    if(copytextbutton){
      replybutton.parentElement.insertBefore(copylinkbutton,copytextbutton)
      replybutton.parentElement.insertBefore(openfilebutton,copylinkbutton)
      replybutton.parentElement.insertBefore(download,copytextbutton.nextSibling)
    }else{
  ...
  function apply() {
    ...
    textfilesvgs.forEach(svg=>{
      ...
      const copyLinkButton = downloadbutton.cloneNode(true)
      ...
      copyLinkButton.addEventListener('click',()=>{
            ...
            navigator.clipboard.writeText(downloadbutton.parentElement.href).catch(err=>{
