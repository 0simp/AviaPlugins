(function () {
  ...
  function animateServerIcons() {
    ...
    const invites = document.querySelectorAll(`div[class='d_flex ai_center w_320px h_64px gap_var(--gap-md) p_var(--gap-md) bdr_var(--borderRadius-md) c_var(--md-sys-color-on-secondary-container) bg_var(--md-sys-color-secondary-container)']`)
